...
public class EliminarMedico extends javax.swing.JPanel {
    
    DialogPaciente manejo = null; 

    public EliminarMedico(DialogPaciente p) {
        manejo = p;
        initComponents();
    ...
    private void ItemsComboMedicos(List<String> medicos){
        ...
        medicos.forEach(region -> {
            comboBoxMedicos.addItem(region);
        });
